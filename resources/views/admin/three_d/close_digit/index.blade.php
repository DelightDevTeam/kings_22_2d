...
<div class="row mt-4">
 <div class="col-12">
  <div class="card">
   ...
   <div class="card mt-2">
     <div class="body">
           <p>You can create new 3d close digit for all users.</p>
           <form class="multisteps-form__form" action="{{ route('admin.CloseDigitStore') }}" method="post">
            @csrf
    ...
    <table class="table table-flush" id="permission-search">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td>
        <form class="d-inline" action="{{ route('admin.DeleteCloseDigit', $digit->id) }}" method="POST">
         @csrf
         @method('DELETE')
