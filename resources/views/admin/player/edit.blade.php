        ...
        <div class="card-body">
          <form role="form" class="text-start" method='post' action="{{route('admin.player.update',$player->id)}}">
            ...
            <div class="custom-form-group">
              ...
              <input type="text" name="phone" class="form-control" value="{{ $player->phone }}" placeholder="Enter Phone Number">
              @error('phone')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
            <div class="custom-form-group">
              ...
              <input type="text" name="limit" class="form-control" value="{{ $player->limit }}" placeholder="0.00">
              @error('limit')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="custom-form-group">
              ...
              <input type="text" name="limit3" class="form-control" value="{{ $player->limit3}}" placeholder="0.00">
              @error('limit3')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="custom-form-group">
              ...
              <input type="text" name="cor" class="form-control" value="{{ $player->cor }}" placeholder="0.00">
              @error('cor')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
            <div class="custom-form-group">
              ...
              <input type="text" name="cor3" class="form-control" value="{{ $player->cor3 }}" placeholder="0.00">
              @error('cor3')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
