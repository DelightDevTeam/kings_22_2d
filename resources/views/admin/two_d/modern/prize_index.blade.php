...
<div class="row mt-4">
    <div class="col-6">
        <div class="card">
            <div class="card-header">
                <h5>2D Modern Prize Digit Create</h5>
            </div>
            ...
            @endphp
            <form action="{{ route('admin.moderns-digits.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="custom-form-group ms-3 mx-3">
                            <label for="prize_no">Modern Prize Number</label>
                            <input type="text" name="modern_digit" id="modern_digit" class="form-control" placeholder="Modern Digit">
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="card mt-3">
            ...
            <div class="card-header pb-0">
                <div>
                    <h5 class="mb-0">2D Modern Prize Digit Create Dashboards</h5>
                </div>
                ...
                <table class="table table-flush" id="twod-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $morningData->modern_digit }}</td>
                            <td>{{ $morningData->session }}</td>
                            <td>{{ $morningData->open_time }}</td>
                            <td>{{ $morningData->created_at->format('F j, Y') }}</td>
                             <td>
                             <form class="d-inline" action="{{ route('admin.moderns-digits.destroy', $morningData->id) }}" method="POST">
                             @csrf
                             @method('DELETE')
    ...
    <div class="col-6">
        <div class="card">
            ...
            <form action="{{ route('admin.moderns-digits.store') }}" method="post">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-form-group ms-3 mx-3">
                            <label for="prize_no">Modern Evening Prize Number</label>
                            <input type="text" name="modern_digit" id="modern_digit" class="form-control" placeholder="Modern Digit">
                        </div>
        ...
        <div class="card mt-3">
            <div class="card-header pb-0">
                <div>
                    <h5 class="mb-0">2D Modern Evening Prize Digit Create Dashboards</h5>
                </div>
                {{-- <div class="d-lg-flex mt-2">
                    <div class="ms-auto my-auto mt-lg-0">
                        <div class="ms-auto my-auto">
                ...
                <table class="table table-flush" id="search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $eveningData->modern_digit }}</td>
                            <td>{{ $eveningData->session }}</td>
                             <td>{{ $eveningData->created_at->format('F j, Y') }}</td>
                             <td>
                             <form class="d-inline" action="{{ route('admin.moderns-digits.destroy', $eveningData->id) }}" method="POST">
                             @csrf
                             @method('DELETE')
                             <button type="submit" class="transparent-btn" data-bs-toggle="tooltip" data-bs-original-title="Delete Role">
                              <i class="material-icons text-secondary position-relative text-lg">delete</i>
