        ...
        <div class="card-body">
          <form role="form" method="POST" class="text-start" action="{{ route('admin.agent.update',$agent->id) }}">
            ...
            <div class="custom-form-group">
              ...
              <input type="text" name="limit" class="form-control" value="{{$agent->limit}}" placeholder="0.00">
              @error('limit')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="custom-form-group">
              ...
              <input type="text" name="limit3" class="form-control" value="{{$agent->limit3}}" placeholder="0.00">
              @error('limit3')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="custom-form-group">
              ...
              <input type="text" name="cor" class="form-control" value="{{$agent->cor}}" placeholder="0.00">
              @error('cor')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
            <div class="custom-form-group">
              ...
              <input type="text" name="cor3" class="form-control" value="{{$agent->cor3}}" placeholder="0.00">
              @error('cor3')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
