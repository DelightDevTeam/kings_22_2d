...
class EveningPrizeStatusHelper
{
    /**
    ...
    public static function getCurrentSession()
    {
        ...
        $eveningSessionStart = Carbon::createFromTimeString('16:30:00', 'Asia/Yangon');
        $eveningSessionEnd = Carbon::createFromTimeString('17:30:00', 'Asia/Yangon')->addDay();
