...
class MorningPrizeStatusCloseHelper
{
    /**
    ...
    public static function getCurrentSession()
    {
        ...
        $morningSessionStart = Carbon::createFromTimeString('13:00:00', 'Asia/Yangon');
        $morningSessionEnd = Carbon::createFromTimeString('13:10:00', 'Asia/Yangon')->addDay();
